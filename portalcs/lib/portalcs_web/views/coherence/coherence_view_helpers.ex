defmodule PortalcsWeb.Coherence.ViewHelpers do
  @moduledoc """
  ...
  @seperator {:safe, "&nbsp; | &nbsp;"}
  @helpers PortalcsWeb.Router.Helpers
  ...
  * :register - customize the register link text (#{@register_link})
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PortalcsWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PortalcsWeb.Gettext, "errors", msg, opts)
    end
  end
